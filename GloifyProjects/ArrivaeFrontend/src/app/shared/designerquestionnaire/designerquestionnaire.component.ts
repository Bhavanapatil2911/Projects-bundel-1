...
@Component({
  ...
  styleUrls: ['./designerquestionnaire.component.css', '../../platform/lead/first-meeting-cs/first-meeting-cs.component.scss'],
...
export class DesignerquestionnaireComponent implements OnInit {
  ...
  'finance','food_&_hospitality','health_care','information_technology','NGOs_&__social_entrepreneurship','sports','other'];
