...
@Component({
  ...
  styleUrls: ['./leadquestionnaire.component.css','../../platform/lead/first-meeting-cs/first-meeting-cs.component.scss'],
...
export class LeadquestionnaireComponent implements OnInit, AfterViewInit {
  ...
  home_value_arr = ['Less than 30 Lacs', '30 - 50 Lacs', '50 - 70 Lacs', '70 - 99 Lacs', '1 - 1.25 Cr',
    '1.26 - 1.75 Cr', '1.76 - 2.50 Cr', '2.51 Cr - 4.00 Cr', 'Above 4.00 Cr', 'Not Available'];
...
TabQuestionire;
  ngOnInit() {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      if (tabParam && tabParam === 'questionnaire') {
        this.TabQuestionire = true
      } else{
        this.TabQuestionire = false
      }
    });
  ...
  getThemeList(){
		this.leadService.getThemeList().subscribe(res=>{
  ...
  getLifeStageList(){
		this.leadService.getLifeStageList().subscribe(res=>{
  ...
  setQuestionnaireDetails(note_records) {
    ...
    this.leadquestionnaireForm.controls['new_locality_value'].setValue('');
    this.leadquestionnaireForm.controls['new_society_value'].setValue('');
    // this.leadquestionnaireForm.controls['lifestage'].setValue(note_records.lifestage.length >0?note_records.lifestage[0].id:'');
    // this.leadquestionnaireForm.controls['theme'].setValue(note_records.apartment_theme.length >0?note_records.apartment_theme[0].id:'');
    this.searchname = "";
    ...
    if (note_records != null) {
      ...
      this.leadquestionnaireForm.controls['lifestage'].setValue(note_records.lifestage.length > 0 ? note_records.lifestage[0].id:null);
      this.leadquestionnaireForm.controls['theme'].setValue(note_records.apartment_theme.length > 0 ? note_records.apartment_theme[0].id:null);
      ...
      for (let i = 0; i < note_records.lead_questionaire_items.length; i++){
        this.checkedList.push({ "name": note_records.lead_questionaire_items[i].name, "price": note_records.lead_questionaire_items[i].price, "quantity": 1 });
      }
    ...
    if(note_records.society !='Others'){
      ...
      this.vaale = 'Others'
      this.leadquestionnaireForm.controls['society'].setValue('Other'+'-'+note_records.new_society_value);
    }
    if(note_records.location !='Others'){
      ...
      this.leadquestionnaireForm.controls['location'].setValue('Other'+'-'+note_records.new_locality_value);
      console.log("6")
    }
    if(note_records.city !='Others'){
      ...
      this.localityChangeValue = 'Others';
        ...
        this.leadquestionnaireForm.controls['city'].setValue('Other'+'-'+ note_records.new_city_value);
      
    }
    this.leadquestionnaireForm.controls['aide_apartment_id'].setValue(note_records.aide_apartment_id)
    console.log(this.leadquestionnaireForm.controls['society'].value)
  ...
  filteredOptionsgoogle
  searchSocietyApigoogle($event) {
    this.isApifiredgoogle = true
   
    this.typeSelectAddress =''
    this.isSelectedgoogle = false
    let searchWord = $event.target.value;
    this.leadService.getSocietyWebapigoogle(searchWord).subscribe(
      res => {
        this.filteredOptionsgoogle = res.predictions
        console.log(this.filteredOptionsgoogle)
       
        
      },
      err => {
        this.filteredOptionsgoogle = []
  ...
  selectOption(address){
    ...
    if(address == 'other' ){
        ...
        this.leadquestionnaireForm.controls['city'].setValue('');
        this.leadquestionnaireForm.controls['pincode'].setValue('')
        this.leadquestionnaireForm.controls['aide_apartment_id'].setValue('')
        this.leadquestionnaireForm.controls['new_locality_value'].setValue('')
        this.leadquestionnaireForm.controls['new_society_value'].setValue('')
        this.leadquestionnaireForm.controls['new_city_value'].setValue('')
        ;
        this.filteredOptions = [];
        this.projectName =  this.leadquestionnaireForm.controls['society'].value;
        this.DeveloperName = '';
        this.pincodePro ='';
        this.FullAdress ='';
        this.citynamePro ='';
      ...
      this.leadquestionnaireForm.controls['society'].setValue(address.apartment_name)
      this.leadquestionnaireForm.controls['city'].setValue(address.city)
        this.leadquestionnaireForm.controls['location'].setValue(address.area_name)
        this.leadquestionnaireForm.controls['new_locality_value'].setValue('')
        let apar_id ;
      ...
      this.leadquestionnaireForm.controls['aide_apartment_id'].setValue(apar_id)
      this.vaale = address.area_name;
      this.localityChangeValue = address.area_name
      
      ;
      this.leadquestionnaireForm.controls['pincode'].setValue(address.pincode)
      this.leadquestionnaireForm.controls['new_society_value'].setValue('')
      ;
    }
  ...
  Submitapart(){
    ...
    this.leadquestionnaireForm.controls['location'].setValue($('#areaname').val());
    this.leadquestionnaireForm.controls['city'].setValue($('#citygoogle').val());
    this.leadquestionnaireForm.controls['new_locality_value'].setValue(this.FullAdress);
    this.leadquestionnaireForm.controls['pincode'].setValue($('#pincodegoogle').val());
    this.leadquestionnaireForm.controls['society'].setValue(this.projectName);
    console.log(this.leadquestionnaireForm.controls['location'].value,$('#autocomplete-input').val())
  ...
  CreateApartment(){
    this.showPopup = false;
    let address = this.leadquestionnaireForm.controls['location'].value;
...
if (pincodeMatch) {
  ...
  pincode =''
    ...
    let obj ={
      ...
      "city": this.leadquestionnaireForm.controls['city'].value,
      "state": ""
  }
     this.leadService.CreateApar(obj).subscribe(Res=>{
      this.leadquestionnaireForm.controls['aide_apartment_id'].setValue(Res.result[0].apartment_id)
      ...
      this.close.emit( this.successMessage);
...
let firstSixCharacters = string?string.substring(0, 6):''

if (myString === firstSixCharacters) {
     return true
} else {
  return false
}
