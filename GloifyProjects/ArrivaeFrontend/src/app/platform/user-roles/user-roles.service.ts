...
export class UserRolesService {
  ...
  private inviteUserUrl =  environment.apiBaseUrl+ '/v1/users/invite_user';
   private championTogglebutton = environment.apiBaseUrl + '/v1/users';
  ...
  getUserList(page,search?, id?, Role?){
   ...
   getChampionTogglebutton(userid, championvalue) {
  ...
  updatePassword(data){
    // {{url}}/v1/user/admin_set_password
      let url = environment.apiBaseUrl +  "/v1/user/admin_set_password"
      return this.http
