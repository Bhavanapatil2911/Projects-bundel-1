...
export class SalesManagerService {
  ...
  private extractDataPage(res:Response){
	...
	getReferUserList(referId,referName,salesId?){
		let url =environment.apiBaseUrl +'/v1/users/'+referId+'/load_referrer_users?role='+referName+'&sales_manager_id='+salesId;
    ...
    uploadLeadExcel(files: File[],leadSource,type,camp,refer,referType,salesmanagerID) {
