...
export class DetailedInfoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      if(params['tab'] === 'questionnaire'){
        this.selectedSet = 'csq'
      }else if(params['tab'] === 'booking_form'){
        this.selectedSet = 'bookform'
      }else if(params['tab'] === 'client_questionnaire' ){
        this.selectedSet = 'questionnaire'
      }else if(params['tab'] === 'competitor_analysis') {
        this.selectedSet = 'scopedoc'
      }else if(params['tab'] === 'customer_demand') {
        this.selectedSet = 'customer_demand'
      }
      else if(params['tab'] === '1st-meeting-questionire') {
        this.selectedSet = '1st-meeting-questionire'
      }
      else{
        this.selectedSet = 'csq'
      }
