...
const routes: Routes = [
  ...
  {
    path : 'manual-escalation',
    canActivate : [LoggedInGuard],
    component : ManualEscalationComponent
  },
  {
  ...
  {
    path: 'lead/:leadId/ObtoOcTrack',
    canActivate: [LoggedInGuard],
    component: ObtoOctrackComponent
  },
  {
    path: 'lead/:leadId/project-tracker',
    canActivate: [LoggedInGuard],
    component: ProjectTrackerComponent
  },
  {
    path: 'lead/boq-comparison-tool',
    canActivate: [LoggedInGuard],
    component: BoqComparisonToolComponent
  }
];
