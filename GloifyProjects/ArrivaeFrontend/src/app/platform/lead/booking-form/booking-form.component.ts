...
@Component({
  ...
  styleUrls: ['./booking-form.component.css','../first-meeting-cs/first-meeting-cs.component.scss'],
...
  successalert;
  ...
  updatePrevForm(form){
    ...
    this.bookingForm.patchValue({aide_apartment_id: form['aide_apartment_id	']});
  }
  ...
      order_value : new FormControl(),
      ...
      gst_number: new FormControl("",[Validators.minLength(15)]),
  ...
  bookingFormSubmit(){
    ...
    if((this.prev_booking_form != undefined) && this.prev_booking_form['id'] ){
      ...
      res => {
        if(this.showPopup ){
          this.showSuccessMessage("Form successfully submitted And Apartment Created");
         } else{
          this.showSuccessMessage("Form successfully submitted");
         }
        this.fetchBookingForm();
...
uploadFileEvent(){
  ...
  selectOption(address){
    ...
    if(address == 'other'){
      this.bookingForm.controls['location'].setValue('');
      this.bookingForm.controls['city'].setValue('');
      this.bookingForm.controls['pincode'].setValue('');
      this.bookingForm.controls['aide_apartment_id'].setValue('');
      this.filteredOptions =[];
      this.projectName =  this.bookingForm.controls['building_name'].value;
      this.DeveloperName = '';
      this.pincodePro ='';
      this.FullAdress ='';
      this.citynamePro ='';
      ...
      this.bookingForm.controls['location'].setValue(address.area_name);
      this.bookingForm.controls['city'].setValue(address.city);
      this.bookingForm.controls['pincode'].setValue(address.pincode);
      this.bookingForm.controls['building_name'].setValue(address.apartment_name );
      let apar_id ;
      ...
      this.bookingForm.controls['aide_apartment_id'].setValue(apar_id);
      this.filteredOptions =[]
    }
  ...
  Submitapart(){
    ...
    this.bookingForm.controls['location'].setValue($('#areaname').val());
    this.bookingForm.controls['city'].setValue($('#citygoogle').val());
    this.bookingForm.controls['pincode'].setValue($('#pincodegoogle').val());
    this.bookingForm.controls['building_name'].setValue(this.projectName);
  ...
  showPopup = false;
  CreateApartment(){
    let address = this.bookingForm.controls['location'].value;
...
if (pincodeMatch) {
  ...
  pincode =''
    ...
    let obj ={
      ...
      "pincode": this.bookingForm.controls['pincode'].value,
      "area_name":$('#areaname').val(),
      "city": this.bookingForm.controls['city'].value,
      "state": ""
  }
     this.leadService.CreateApar(obj).subscribe(Res=>{
      this.bookingForm.controls['aide_apartment_id'].setValue(Res.result[0].apartment_id)
