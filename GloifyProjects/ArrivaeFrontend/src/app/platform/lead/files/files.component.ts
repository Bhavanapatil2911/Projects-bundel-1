...
LoaderTest
    ...
    this.leadService.getLeadLogs(this.lead_id).subscribe(
      (res) => {
        ...
        this.route.queryParams.subscribe((params) => {
          ...
          params['tab'] ? this.displaySection(params['tab']):this.displaySection('floorplan-section')
  ...
  displaySection(section) {
    ...
    if (section == "site-section") {
      ...
      this.fetchPptList();
      this.defaultPptList();
    } else if (section == "file-inspiration") {
      this.fetchInspirationList();
  ...
  fetchPdfList() {
    ...
    this.pdfFileList = [
      {
        pdf_url: "https://delta.arrivae.com" + "/assets/img/file.pdf",
        name: "Test",
        id: this.project_id,
      },
    ];
