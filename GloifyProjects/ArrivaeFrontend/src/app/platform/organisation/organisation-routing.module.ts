...
const routes: Routes = [
  ...
  {
    path: 'cm-dgm-mapping',
    component: CmDgmMappingComponent,
    canActivate: [LoggedInGuard]
  ...
  {
    path: "promo-packages",
    component: PromoPackagesComponent,
    canActivate: [LoggedInGuard],
  },
  {
    path: "lead-store",
    component: LeadStoreComponent,
    canActivate: [LoggedInGuard],
  },
  {
    path: "store-mgmt",
  ...
  {
    path: "promo-packages/create-promo-packages/:id",
    component: CreatePromoPackagesComponent,
    canActivate: [LoggedInGuard],
  },
  {
    path: "cm-gm-mapping",
    canActivate: [LoggedInGuard],
    component: CmGmMappingComponent,
  },
  {
    path: 'sm-cm-mapping',
    component: SmCmMappingComponent,
    canActivate: [LoggedInGuard]
  ...
  {
    path: 'asm-sm-mapping',
    component: AsmSmMappingComponent,
    canActivate: [LoggedInGuard]
    
  },
  {
    path: 'design-studio',
    component: DesignStdioComponent,
    canActivate: [LoggedInGuard],
  },
  {
    path: "apartment",
  ...
  {
    path: "noc-screen",
    component: NocScreenComponent,
    canActivate: [LoggedInGuard],
  },
  {
    path: "noc-screen/zero-to-forty",
    component: ZeroToFortyComponent,
    canActivate: [LoggedInGuard],
  },
  {
    path: "noc-screen/fifty-to-hundred",
    component: FortyToHundredComponent,
    canActivate: [LoggedInGuard],
  },
  {
  ...
  {
    path: 'noc-screen/handover',
    component: HandoverNocComponent,
    canActivate: [LoggedInGuard]
  },
  {
    path: 'noc-screen/handover',
    ...
    path : 'noc-screen/snag',
    component : SnagNocComponent,
    canActivate : [LoggedInGuard]
  },
  {
    path:'boq-view-noc',
    component:BoqViewNocComponent,
    canActivate: [LoggedInGuard]
  },
  {
    path: 'community_manger',
