...
@Component({
  selector: "app-forty-to-hundred",
  templateUrl: "./forty-to-hundred.component.html",
  styleUrls: ["./forty-to-hundred.component.css"],
  providers: [LeadService],
})
export class FortyToHundredComponent implements OnInit {
  startCase = startCase;
  // @Output() projectEvent = new EventEmitter<string>();
  // @Output() cdeevent = new EventEmitter<{ name1: number, name2: number }>();
  items: any;
  allowed_items = "40_100";
  current_page: any = 1;
  per_page: any = 10;
  total_page;
  page_number;
 ...
 getfeaturedliving(data: any) {
  ...
  getBOQdetails(leadId: any, index: any) {
    ...
    this.leadService.getBoqDetailforty(leadId).subscribe((response) => {
