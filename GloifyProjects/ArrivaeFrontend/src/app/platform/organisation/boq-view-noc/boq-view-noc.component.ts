...
@Component({
  selector: 'app-boq-view-noc',
  templateUrl: './boq-view-noc.component.html',
  styleUrls: ['./boq-view-noc.component.css'],
  providers: [LeadService],
})
export class BoqViewNocComponent implements OnInit {
  startCase=startCase;
  leadDetails:any;
  role:any;
