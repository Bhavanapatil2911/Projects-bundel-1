...
export class ListLeadOfLeadheadComponent implements OnInit {
  ...
  scopeOfwork = [
    "Modular Kitchen",
    "Loose Furniture",
    "Full Home Interiors (Design)",
    "Full Home Interiors (Design & Fullfilment)",
  ...
  ngOnInit() {
    ...
    if (
      this.queryParamsLeadSource != undefined &&
      this.queryParamsLeadSource.length > 0
    ) {
      this.lead_source_idArr = this.queryParamsLeadSource;
    }
    if (
      this.queryParamsLeadCamp != undefined &&
      this.queryParamsLeadCamp.length > 0
    ) {
      this.lead_campaign_idArr = this.queryParamsLeadCamp;
    }
    if (
      this.queryParamsLeadType != undefined &&
      this.queryParamsLeadType.length > 0
    ) {
      this.lead_type_idArr = this.queryParamsLeadType;
    }
    if (
      this.queryParamsCMType != undefined &&
      this.queryParamsCMType.length > 0
    ) {
      this.cm_type_idArr = this.queryParamsCMType;
    }
    if (
      this.queryParamsMKWFHI != undefined &&
      this.queryParamsMKWFHI.length > 0
    ) {
      this.mkw_fhi_Arr = this.queryParamsMKWFHI;
    }
    if (
      this.queryParamsFromDate != undefined &&
      this.queryParamsFromDate != ""
    ) {
    ...
    if (this.lead_status != undefined) {
      ...
      this.dropdownSettings2["text"] = this.lead_status
        .replace(/_/g, " ")
        .toLowerCase()
        .split(" ")
    ...
    this.meetingform = new FormGroup({
      ...
      agenda : new FormControl('PM10: 1st Meeting CS'),
      // ownerable_type : new FormControl('Project'),
      contact_type: new FormControl(null, Validators.required), // type
      description: new FormControl(), // description
      scheduled_at: new FormControl(  // date
    ...
    this.leadService
      ...
      .subscribe(
        (res) => {
          ...
          this.filteredLeads = this.sortFunc(this.filteredLeads, {
            property: "id",
            direction: "-1",
          });
  ...
  reasonForLostDropdownChange(val) {
    if (
      ...
      this.updateLeadForm.controls["lost_remark"].setValidators([
        Validators.required,
      ]);
    } else {
  ...
  dropdownList5 = [];
  dropdownList6 = [
    { id: "created_at", itemName: "Acquisition Date" },
    { id: "status_updated_at", itemName: "Status Updated Date" },
  ];
  dropdownList7 = [];
  ...
  selectedItems8 = [];
  dropdownList9 = [
    { id: "internal", itemName: "Internal" },
    { id: "external", itemName: "External" },
  ];
  selectedItems9 = [];
  dropdownList10 = [
    { id: "mkw", itemName: "MKW" },
    ...
    if (textVal == "Status" && index == 1) {
      for (var k = 0; k < this.selectedItems2.length; k++) {
        document
          .getElementsByClassName("c-btn")
          [index].getElementsByTagName("span")[0].innerHTML +=
          this.selectedItems2[k].itemName + ",";
      }
      ...
      for (var k = 0; k < this.selectedItems3.length; k++) {
        document
          .getElementsByClassName("c-btn")
          [index].getElementsByTagName("span")[0].innerHTML +=
          this.selectedItems3[k].itemName + ",";
      }
      ...
      for (var k = 0; k < this.selectedItems4.length; k++) {
        document
          .getElementsByClassName("c-btn")
          [index].getElementsByTagName("span")[0].innerHTML +=
          this.selectedItems4[k].itemName + ",";
      }
      ...
      for (var k = 0; k < this.selectedItems5.length; k++) {
        document
          .getElementsByClassName("c-btn")
          [index].getElementsByTagName("span")[0].innerHTML +=
          this.selectedItems5[k].itemName + ",";
      }
      ...
      for (var k = 0; k < this.selectedItems6.length; k++) {
        document
          .getElementsByClassName("c-btn")
          [index].getElementsByTagName("span")[0].innerHTML +=
          this.selectedItems6[k].itemName + ",";
      }
      ...
      for (var k = 0; k < this.selectedItems8.length; k++) {
        if (
          ...
          document
            .getElementsByClassName("c-btn")
            [index].getElementsByTagName("span")[0].innerHTML +=
            this.selectedItems8[k].itemName;
        }
      }
      ...
      for (var k = 0; k < this.selectedItems9.length; k++) {
        if (
          ...
          document
            .getElementsByClassName("c-btn")
            [index].getElementsByTagName("span")[0].innerHTML +=
            this.selectedItems9[k].itemName;
        }
      }
      ...
      for (var k = 0; k < this.selectedItems10.length; k++) {
        if (
          ...
          document
            .getElementsByClassName("c-btn")
            [index].getElementsByTagName("span")[0].innerHTML +=
            this.selectedItems10[k].itemName;
        }
      }
      ...
      for (var k = 0; k < this.selectedItems7.length; k++) {
        document
          .getElementsByClassName("c-btn")
          [index].getElementsByTagName("span")[0].innerHTML +=
          this.selectedItems7[k].itemName + ",";
      }
    }
  }
  ...
  filterData() {
    ...
    for (var k = 0; k < this.selectedItems2.length; k++) {
      this.lead_statusArr.push(
        this.selectedItems2[k].itemName.toLowerCase().replace(/ /g, "_")
      );
    }
    for (var k = 0; k < this.selectedItems3.length; k++) {
    ...
    this.leadService
      ...
      .subscribe(
        (res) => {
          ...
          this.successMessage =
            "Your Lead Report will be Downloaded in a while";
          setTimeout(
            function () {
  ...
  updateLeadFormSubmit(data) {
    ...
    if(data['store_id'] == "Not Assigned"){
      data['store_id'] = null
    }
if(data['store_id'] !=="Not Assigned" &&data['store_id'] == this.getstoreitem){
  data['store_id'] = this.getStoreId
}
    if (
      data["lead_status"] == "qualified" &&
      data["lead_type_name"] == "customer" &&
      (data["pincode"] == "" ||
        data["pincode"] == null ||
 ...
 getStoreId:any
  setUpdatedLead(value) {
    ...
    this.updateLeadForm.controls["lead_source_id"].setValue(
      value.lead_source_id
    );
    this.getstoreitem = value.store_details.name;
    this.getStoreId = value.store_details.id;
    this.updateLeadForm.controls["store_id"].setValue(value.store_details.name);
    this.updateLeadForm.controls["referrer_type"].setValue(
      value.referrer_type || ""
    );
    this.updateLeadForm.controls["lead_campaign_id"].setValue(
      value.lead_campaign_id
    );
    this.updateLeadForm.controls["referrer_id"].setValue(
      value.referrer_id || ""
    );
    this.userList = [value.referrer];
    this.updateLeadForm.controls["lead_status"].setValue(value.lead_status);
    value.follow_up_time != null
      ? this.updateLeadForm.controls["follow_up_time"].setValue(
          new Date(value.follow_up_time)
        )
      : "";
    ...
    console.log(this.updateLeadForm.controls["lead_type_name"].value),"mmmm";
    this.updateLeadForm.controls["instagram_handle"].setValue(
    ...
    if (
      value.lost_reason == "low_budget" ||
      value.lost_reason == "non_serviceable_area" ||
      value.lost_reason == "out_of_scope" ||
      value.lost_reason == "general_inquiry/not_interested" ||
      value.lost_reason == "language_barrier" ||
      value.lost_reason == "already_done_with_other_vendor" ||
      value.lost_reason == "others"
    ) {
      document
        .getElementById("lostremark")
        .setAttribute("style", "display: block");
    ...
    this.leadService
      ...
      .subscribe(
        (res) => {
          ...
          this.basefile = undefined;
          this.successMessage =
            res["new_leads"].length + " new leads uploaded successfully !!";
          setTimeout(
            function () {
              this.successalert = false;
            }.bind(this),
  ...
  onDropdownChange(id, value, rowid) {
    ...
    if (
      this.assignedAgentId[rowid] != undefined &&
      this.assignedAgentId[rowid] != "Assign To CS Agent"
    ) {
      document
        .getElementById("assigndropdown" + id)
  ...
  assignLeadToAgent(id: number, index: number) {
    if (
      ...
      this.assignedAgentId[index] != "Assign To CS Agent"
    ) {
      this.loaderService.display(true);
      this.leadService
        .assignLeadToAgent(this.assignedAgentId[index], id)
        .subscribe(
          (res) => {
  ...
  closeModal(msg?) {
    ...
    if (msg != 'Apartment Created Successfully') {
  ...
  viewLeadLog(leadId, rowID) {
    this.loaderService.display(true);
    this.leadService.getactivitylogs(leadId,true).subscribe(
      (res) => {
        Object.keys(res).map((key) => {
  ...
  assignCmToLead(leadid, index, cmId?, designerId?) {
    ...
    this.leadName = this.filteredLeads[index].name
    this.assigneIndex = index;
    this.projectId = this.filteredLeads[index].project_id
    this.meetingform.controls['ownerable_id'].setValue(this.projectId);
    if (
      ...
      this.leadService
        ...
        .subscribe(
          (res) => {
            // if(  !this.filteredLeads[index].next_scheduled_event && (this.role == 'cs_agent' || this.role == 'lead_head')   ){
            //   $("#csCreateEvent").modal("show");
            // }
            // if(   (this.role == 'cs_agent' || this.role == 'lead_head')   ){
            //   $("#csCreateEvent").modal("show");
            // }
            if (res.community_managers) {
              ...
              this.successMessage = "Assigned Successfully !!";
              if(   (this.role == 'cs_agent' || this.role == 'lead_head' || this.role == 'admin' )   ){
                $("#csCreateEvent").modal("show");
              }
              this.resetDropDown();
              $(window).scrollTop(0);
  ...
  smartShareEmail() {
    this.leadService.smartShareReport().subscribe(
      (res) => {
        this.successalert = true;
        this.successMessage =
          "The Smart-Share report you requested is being created. It will be emailed to you once complete.!";
        setTimeout(
          function () {
            this.successalert = false;
          }.bind(this),
  ...
  downloadQuestionnaire() {
    this.leadService.exportQuestionnaireEvent().subscribe(
      (res) => {
        this.successalert = true;
        this.successMessage =
          "The  Questionnaire  report you requested is being created. It will be emailed to you once complete.!";
        setTimeout(
          function () {
            this.successalert = false;
          }.bind(this),
  ...
  createEvent(){
    this.loaderService.display(true)
    this.cmservice.createEventForCM(this.projectId,this.meetingform.value).subscribe((res) => {
      this.loaderService.display(false)
      // console.log(res);
  ...
  agendaname : 'PM10:_first_meeting_with_cs'
  resetMeetingForm(){
    $("#csCreateEvent").modal("hide");
    this.meetingform.reset()
    this.meetingform.controls['agenda'].setValue("PM10: 1st Meeting CS");
  }
  sheduleAgain : boolean = false
  checkToCreateEventAgain(id, name , project){
    this.cmservice.canAgainCreate(project).subscribe((res) => {
      console.log(res);
       this.sheduleAgain = true
       this.createSecondMeeting(id , name , project)
    },(err) => {
      ...
      this.sheduleAgain = false
    })
  }
  createSecondMeeting(id , name, projectId){
    this.meetingform.controls['ownerable_id'].setValue(projectId);
    this.leadName = name
    this.assigneLeadId = id
