...
import { PromoPackagesComponent } from "./promo-packages/promo-packages.component";

import { CmGmMappingComponent } from "./cm-gm-mapping/cm-gm-mapping.component";
import { CreatePromoPackagesComponent } from "./create-promo-packages/create-promo-packages.component";
import { DesignStdioComponent } from "./design-stdio/design-stdio.component";
import { ApartmentComponent } from "./apartment/apartment.component";
import { ApartmentImageUploadComponent } from "./apartment/apartment-image-upload/apartment-image-upload.component";
import { LeadStoreComponent } from "./lead-store/lead-store.component";
import { SaveLeadStoreDataComponent } from "./lead-store/save-lead-store-data/save-lead-store-data.component";
import { NocScreenComponent } from "./noc-screen/noc-screen.component";
import { ZeroToFortyComponent } from "./zero-to-forty/zero-to-forty.component";
import { FortyToHundredComponent } from "./forty-to-hundred/forty-to-hundred.component";
import { QwertPipe } from "./qwert.pipe";
import { AddApartmentComponent } from "./add-apartment/add-apartment.component";
import { ListApartmentComponent } from "./list-apartment/list-apartment.component";
import { QuotationModule } from "../quotation/quotation.module";
import { StoreMgmtComponent } from "./store-mgmt/store-mgmt.component";
import { SaveStoreDataComponent } from "./store-mgmt/save-store-data/save-store-data.component";
import { CreateapartmentComponent } from './add-apartment/createapartment/createapartment.component';
import { HandoverNocComponent } from "./handover-noc/handover-noc.component";
import { BoqViewNocComponent } from './boq-view-noc/boq-view-noc.component';
import { SnagNocComponent } from './snag-noc/snag-noc.component';
import { SmCmMappingComponent } from './sm-cm-mapping/sm-cm-mapping.component';
import { DetailedInfoComponent } from './detailed-info/detailed-info.component';
import { TeamListComponent } from "./team-list/team-list.component";
import { AsmSmMappingComponent } from './asm-sm-mapping/asm-sm-mapping.component';
import { SalesManagerComponent } from './catalogue/sales-manager/sales-manager.component';
import { CommunityManagerComponent } from './catalogue/community-manager/community-manager.component';
import { CmDgmMappingComponent } from './cm-dgm-mapping/cm-dgm-mapping.component';
...
@NgModule({
  ...
  declarations: [
    ...
    GetacallbackContactDetailsComponent,
    ViewservicedetailsComponent,
    ListDesignerportfolioComponent,
    CreateDesignerportfolioComponent,
    ViewDesignerportfolioComponent,
    CsagentdashboardComponent,
    CmDashboardComponent,
    BrokerDashboardComponent,
    BrokerMgmtComponent,
    ListbrokersComponent,
    ListDesignerComponent,
    ProjectListDesignerComponent,
    CmLeadsListComponent,
    DesignerMgmtComponent,
    BrokerLeadmgmtComponent,
    CsagentStatuslistComponent,
    ListcampaignComponent,
    LeadsPriorityComponent,
    ListLeadOfLeadheadComponent,
    CmWipComponent,
    CmActionableComponent,
    CmActionableListComponent,
    CmDeadlinesComponent,
    SitesupervisorMgmtComponent,
    CmSiteRequestComponent,
    CmDesignerListComponent,
    CmPaymentComponent,
    ...
    MediaEngagementComponent,
    CmDataMigrationComponent,
    LeadPriorityDisplayComponent,
    LeadMetricComponent,
    MkwbusinessheadMetricComponent,
    CmDesMetricComponent,
    CommunityMetricComponent,
    SalesManagerMappingComponent,
    underScorePipe,
    NewViewCatalogueComponent,
    NewViewCatalogueDetailsComponent,
    SegmentCatalogueComponent,
    CmstatuslistComponent,
    SortDateTimewisePipe,
    CmGmMappingComponent,
    PromoPackagesComponent,
    CreatePromoPackagesComponent,
    DesignStdioComponent,
    ApartmentComponent,
    ApartmentImageUploadComponent,
    LeadStoreComponent,
    SaveLeadStoreDataComponent,
    NocScreenComponent,
    ZeroToFortyComponent,
    FortyToHundredComponent,
    QwertPipe,
    AddApartmentComponent,
    ListApartmentComponent,
    StoreMgmtComponent,
    SaveStoreDataComponent,
    CreateapartmentComponent,
    HandoverNocComponent,
    BoqViewNocComponent,
    SnagNocComponent ,
    TeamListComponent,
    SmCmMappingComponent,
    DetailedInfoComponent ,
    AsmSmMappingComponent,
    SalesManagerComponent  ,
    CommunityManagerComponent,
    CmDgmMappingComponent  ],
})
