...
import { ViewlogsComponent } from "./lead/viewlogs/viewlogs.component";
...
import { BrowsePresetComponent } from "./browse-preset/browse-preset.component";
import { BrowsePresetInclusionComponent } from "./browse-preset-inclusion/browse-preset-inclusion.component";
import { DesignerAttendenceComponent } from './designer-attendence/designer-attendence.component';
import { CustomerreviewComponent } from './customer/user-onboard/customerreview/customerreview.component';
@NgModule({
  imports: [
    CommonModule,
  ...
  declarations: [
    ...
    BrowsePresetComponent,
    BrowsePresetInclusionComponent,
    DesignerAttendenceComponent,
