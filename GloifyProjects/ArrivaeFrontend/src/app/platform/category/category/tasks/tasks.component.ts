...
export class TasksComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activatedRoute.queryParams.subscribe(params => {
      params['tab'] ? this.activateTab(params['tab']):this.activateTab('handover_for_production')
  ...
  activateTab(tab){
    this.categoryFilter =''
    if(localStorage.getItem('taks_page') ==null){
  ...
  searchCategoryProjects(searchparam){
    switch(this.selectedTab){
      ...
      this.custom_element_child.searchCategoryProjects(searchparam);
        break;
      case "pre_production":
      this.pre_production_child.searchCategoryProjects(searchparam,this.categoryFilter);
        break;
      case "cad_approvals":
      this.cad_approvals_child.searchCategoryProjects(searchparam);
        break;
      case "handover_for_production":
      this.handover_production_child.searchCategoryProjects(searchparam,this.categoryFilter);
        break;
    }
