...
import { RaiseRequestComponent } from './payments-release/raise-request/raise-request.component';
...
import { OfficePoComponentComponent } from './office-po-component/office-po-component.component';
...
@NgModule({
  ...
  declarations: [
    ...
    VendorpoMaintenanceComponent,
    VendorSummaryComponent,
    MtoPoComponent,
    CategoryHierachyComponent,
    OfficePoComponentComponent,
    CategoryDashboardComponent,
    PmHundredDashboardComponent,
    MtoBatchesComponent
  ],
  providers: [
