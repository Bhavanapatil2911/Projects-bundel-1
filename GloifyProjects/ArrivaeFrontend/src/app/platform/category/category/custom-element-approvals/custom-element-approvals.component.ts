...
export class CustomElementApprovalsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getProjectList(parseInt(localStorage.getItem('taks_page')));
  }
  ...
  pushTOAide(projectId , Id){
    this.loaderService.display(true)
    this.categoryService.AddCustomElementToAide(projectId,Id).subscribe(
      res => {
        this.loaderService.display(false);
        this.successalert = true;
        ...
        this.successMessage = res.message
          ...
          this.categoryService.getCustomElements(projectId).subscribe(
            res=>{
              this.customList = res['custom_elements'];
              // this.selectSpace(this.project_id,event);
             },
