...
export class WipOrdersComponent implements OnInit {
  ...
  current_page;
  page: any = 1;
  getWipTableData(page, search?) {
    this.page_number = page;
    this.loaderService.display(true);
    this.categoryService.getWipTable(this.page_number, this.project_type, search).subscribe(
      res => {
        ...
        // this.wipData_data = res.vendor?.wip_slis;
  ...
  addSublineItem() {
    this.loaderService.display(true);
    this.categoryService.addSublineItems2(this.sublineItemForm.value).subscribe(
      res => {
        this.loaderService.display(false);
  ...
  getAddress() {
    ...
    this.address_list = [
      ...
      {
        address_name: "Aide Technologies Pvt Ltd",
        name: "",
        contact: "",
    ...
    this.address_list_billing = [
      ...
      },
      {
        Shipping_address_name:
          "RAWAT BROTHERS FURNITURE PVT. LTD, (For Raw Material)",
        contact: "9130606486",
        name: "Laxman",
        address:
      ...
      {
        Shipping_address_name: "Vista Modular System",
        contact: "8053485454",
        name: "Pradeep",
        address:
          "Vista Modular System, Plot No.95 Sector - 4, IMT Manesar, Gurugram, Haryana.",
      },
      {
        Shipping_address_name: "Krish Furniture Components",
        name: "Champak",
        contact: "9008451673",
        address:
      ...
      {
        Shipping_address_name: "Flora Interior Solutions",
        name: "Venugopal ",
        contact: "9035241661",
        address:
      ...
      {
        Shipping_address_name: "Futhura Warehouse",
        name: "Abhijith",
        contact: "9743258596",
        address:
  ...
  searchForPo(val) {
    this.getWipTableData(this.page, val)
  }
