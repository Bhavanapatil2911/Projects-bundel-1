...
@Component({
  selector: "app-bulk-vendor-payment",
  templateUrl: "./bulk-vendor-payment.component.html",
  styleUrls: ["./bulk-vendor-payment.component.css"],
  providers: [FinanceService, LeadService, CategoryService],
})
export class BulkVendorPaymentComponent implements OnInit {
  role;
  successalert = false;
  ...
  getcompletedvendor(e) {
    ...
    this.loaderService.display(true);
    this.financeService
      .getFinalRequestVendorcompletedmain(
        this.current_page,
        this.FromDate,
        this.ToDate,
        this.clientId,
