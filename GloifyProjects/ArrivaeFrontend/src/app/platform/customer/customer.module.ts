...
import { DesignerDashboard2Component } from './designer-dashboard-2/designer-dashboard-2.component';
import { PromoterMngtComponent } from './promoter-mngt/promoter-mngt.component';
...
@NgModule({
  ...
  declarations: [
    DashboardComponent,
    ViewUserOnboardComponent,
    UserOnboardComponent,
    HelpComponent,
    ContactComponent,
    TouComponent,
    FaqComponent,
    ArrivaeProductsComponent,
    ProjectsComponent,
    LogsComponent,
    DiscountProposalComponent,
    DesignerProposalComponent,
    FilesComponent,
    MeetComponent,
    FinalDesignProposalComponent,
    ScheduledCallsComponent,
    ViewPresentationComponent,
    ViewBoqComponent,
    CusChangePasswordComponent,
    CusViewProfileComponent,
    SharedFilesComponent,
    NextLine,
    OpsDashboardComponent,
    DesignerDashboardComponent,
    DesignerDashboard2Component,
    PromoterMngtComponent,
  ],
})
