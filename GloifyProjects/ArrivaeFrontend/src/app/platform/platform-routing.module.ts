...
const routes: Routes = [
  ...
  {
    path:'designer-attendence',
    component:DesignerAttendenceComponent,
    canActivate:[LoggedInGuard]
  },
  {
    path:'mom-form',
  ...
  {
    path:'browse-preset',
   component:BrowsePresetComponent,
  },
  {
    path: 'browse-preset-inclusion/:id',
    component: BrowsePresetInclusionComponent
  }
