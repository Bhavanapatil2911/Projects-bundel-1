...
import { ShowCurtainListComponent } from "./show-curtain-list/show-curtain-list.component";
import { CurtainDetailsComponent } from "./curtain-details/curtain-details.component";
import { CreateModularQuotationCardComponent } from './create-modular-quotation-card/create-modular-quotation-card.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ImportquotationComponent,
    CreateLooseQuoteComponent,
    CreateModularQuoteComponent,
    ViewLooseQuoteComponent,
    GlobalvarpresetComponent,
    MkwLayoutsComponent,
    ShowCurtainListComponent,
    CurtainDetailsComponent,
    CreateModularQuotationCardComponent,
  ],
  exports: [
    CreateLooseQuoteComponent,
    CreateModularQuoteComponent,
